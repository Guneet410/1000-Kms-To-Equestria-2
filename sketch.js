...
function spikeSpawn(){
  spike  = createSprite(windowWidth+10,windowHeight/2 +250,20,10);
  spike.velocityX = -8 ;
...
function stoneSpawn(){
  stones = createSprite(windowWidth+10,windowHeight/2 +250,20,10);
...
function arrows(){
  arrow = createSprite(windowWidth+10,random(windowHeight/2 +150,windowHeight/2 +200) ,20,10);
  arrow.velocityX = -6
